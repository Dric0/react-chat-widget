...
export function addOlderMessages(component: ElementType, props: any): void;
export function addOlderMessages(component: ElementType, props: any, showAvatar: boolean): void;
